...
### Run alignment on ZI + Ancestor sequences using macse (v. 2.07)
...
### Split sequences > 900 by chunks of 900  
Use python script split_in_900.py  
9137 proteins splitted into 10573  

### Run MASS-PRF following https://github.com/Townsend-Lab-Yale/MASSPRF 
